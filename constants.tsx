...
export const DEFAULT_PROCEDURES: Procedure[] = [
  { name: 'Molde F1', duration: '2h' },
  { name: 'Banho de Gel', duration: '1h30' },
  { name: 'Blindagem', duration: '1h' },
  { name: 'Manicure Tradicional', duration: '1h' },
  { name: 'Pé Tradicional', duration: '1h' },
  { name: 'Pé Blindagem', duration: '1h' },
  { name: 'Manutenção', duration: '1h30' }
];
